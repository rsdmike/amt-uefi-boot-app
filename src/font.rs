/// VGA 8x16 bitmap font for GOP rendering.
/// Each glyph: 16 bytes (one per row, MSB = leftmost pixel).

pub fn glyph(ch: char) -> &'static [u8; 16] {
    match ch {
        '\x20'..='\x7E' => &ASCII[(ch as u8 - 0x20) as usize],
        '\u{2550}' => &BOX_H,
        '\u{2551}' => &BOX_V,
        '\u{2554}' => &BOX_TL,
        '\u{2557}' => &BOX_TR,
        ...
        '\u{2560}' => &BOX_LT,
        '\u{2563}' => &BOX_RT,
        _ => &ASCII[0], // fallback: space
    }
}

// Box drawing: 2px-wide lines, vertical at cols 3-4 (0x18), horizontal at rows 7-8 (0xFF)
const BOX_H:  [u8; 16] = [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0x00];
const BOX_V:  [u8; 16] = [0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18];
const BOX_TL: [u8; 16] = [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1F,0x1F,0x18,0x18,0x18,0x18,0x18,0x18,0x18];
const BOX_TR: [u8; 16] = [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xF8,0xF8,0x18,0x18,0x18,0x18,0x18,0x18,0x18];
const BOX_BL: [u8; 16] = [0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x1F,0x1F,0x00,0x00,0x00,0x00,0x00,0x00,0x00];
const BOX_BR: [u8; 16] = [0x18,0x18,0x18,0x18,0x18,0x18,0x18,0xF8,0xF8,0x00,0x00,0x00,0x00,0x00,0x00,0x00];
const BOX_LT: [u8; 16] = [0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x1F,0x1F,0x18,0x18,0x18,0x18,0x18,0x18,0x18];
const BOX_RT: [u8; 16] = [0x18,0x18,0x18,0x18,0x18,0x18,0x18,0xF8,0xF8,0x18,0x18,0x18,0x18,0x18,0x18,0x18];

/// Printable ASCII 0x20 (' ') through 0x7E ('~'), VGA 8x16 style.
const ASCII: [[u8; 16]; 95] = [
    ...
    [0x00,0x00,0x00,0x6C,0x6C,0xFE,0x6C,0xFE,0x6C,0x6C,0x00,0x00,0x00,0x00,0x00,0x00], // 0x23 '#'
